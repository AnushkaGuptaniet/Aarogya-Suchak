...
def chat():
    ...
    if "liver" in msg:
        reply = " Liver symptoms detected. Avoid alcohol, eat healthy, and consult a doctor."

    elif "kidney" in msg:
        reply = " Kidney care: drink water, reduce salt, avoid junk food."

    elif "heart" in msg:
        reply = " Maintain BP, avoid oily food, do exercise."

    elif "diabetes" in msg:
        reply = " Control sugar intake and monitor glucose."

    elif "improve" in msg or "health" in msg:
        reply = " Eat healthy, drink water, exercise daily."
